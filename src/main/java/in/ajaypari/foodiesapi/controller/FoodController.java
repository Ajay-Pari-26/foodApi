package in.ajaypari.foodiesapi.controller;
...
import in.ajaypari.foodiesapi.service.FoodService;
...
public class FoodController {
    ...
    @PostMapping
    public FoodResponse addFood(@RequestParam("food") String foodString,
